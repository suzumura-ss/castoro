...
describe Castoro::Protocol::Command::Create do
  ...
  context 'when initialize, argument for basket set "1.2.3", argument for hints set {"length" => "12345", "class" => 1}' do
    it "should be able to create an instance of create command." do
      Castoro::Protocol::Command::Create.new("1.2.3", {"length" => "12345", "class" => 1}).should be_kind_of(Castoro::Protocol::Command::Create)
    end
...
describe Castoro::Protocol::Response::Create do
  context 'when initialize, argument for error set nil, argument for basket set to "1.2.3"' do
...
describe Castoro::Protocol::Response::Create::Gateway do
  ...
  context 'when initialize, argument for basket set "1.2.3", argument for hosts set [ "host100", "host101", "host102" ] ' do
    it 'should be able to create an instance of create gateway response.' do
      Castoro::Protocol::Response::Create::Gateway.new(nil, "1.2.3", [ "host100", "host101", "host102" ]).should be_kind_of(Castoro::Protocol::Response::Create::Gateway)
    end
...
describe Castoro::Protocol::Response::Create::Peer do
  ...
  context 'when initialize, argument for error set nil, argument for basket set "1.2.3", argument for host set "host100", argument for path set "/path/1.2.3"' do
