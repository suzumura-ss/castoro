...
<pre>
gem uninstall castoro-groupctl
gem install --no-rdoc --no-ri castoro-groupctl-0.0.2.gem
cd /usr/local/lib/ruby/gems/1.9.1/gems/castoro-groupctl-0.0.2/etc/init.d
make install
cd /usr/local/lib/ruby/gems/1.9.1/gems/castoro-groupctl-0.0.2/etc/castoro
...
<pre>
groupctl startall peer000 peer001 peer002
