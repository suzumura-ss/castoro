...
gem install -V --no-rdoc --no-ri castoro-pgctl-0.4.0.gem

cd /usr/local/lib/ruby/gems/1.9.1/gems/castoro-pgctl-0.4.0/etc/castoro
cp pgctl.conf-sample-ja.conf /etc/castoro/pgctl.conf
vi /etc/castoro/pgctl.conf
</pre>

There is no need to do "cd /usr/local/lib/ruby/gems/1.9.1/gems/castoro-pgctl-0.4.0/etc/init.d ; make install"
That will be automatically done upon "gem install castoro-pgctl-0.4.0.gem"

h3. Starting daemon processes on CentOS
<pre>
chkconfig --list cstartd ; chkconfig --list cagentd
service cstartd start ; service cagentd start
</pre>
...
h3. Starting daemon processes on OpenSolaris
<pre>
svcadm disable cstartd
svcadm enable cstartd
svcadm disable cagentd
svcadm enable cagentd
svcs cstartd cagentd
svcs -xv cstartd
svcs -xv cagentd
</pre>
...
h2. Uninstallation
<pre>
/usr/local/lib/ruby/gems/1.9.1/gems/castoro-pgctl-0.4.0/etc/init.d
make uninstall
gem uninstall castoro-pgctl
</pre>
...
<pre>
$ pgctl -h
pgctl - Castoro Peer Group Control command - Version 0.4.0"
...
A new pgctl password has been successfully set.
...
A pgctl password has been successfully changed.
...
A pgctl password has been successfully erased. Now, no password is set.
