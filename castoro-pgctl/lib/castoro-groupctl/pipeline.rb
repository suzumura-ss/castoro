...
module Castoro
  module Peer
    ...
    # This Pipeline is a working alternative to Queue proveded by require 'thread'.
    # Unfortunately, Queue in Ruby 1.9.1 does not work well.

    # Note that this code is tuned for ruby-1.9.1-p378/thread.c and 
    # this might not efficiently work with other versions rather than Ruby 1.9.1
