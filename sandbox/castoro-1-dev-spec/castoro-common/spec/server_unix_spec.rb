...
describe Castoro::Server::UNIX do
  before do
    @temp_sock_file = Tempfile::new("castoro-server-unix").path
  end

  context "when the logger argument is omitted." do
    before do
      @s = Castoro::Server::UNIX.new(nil, @temp_sock_file)
    end
    ...
    context "when start" do
      ...
      it "should @unix_server is valid and opened" do
        unix_server = @s.instance_variable_get :@unix_server
        unix_server.should_not be_nil
        unix_server.closed?.should be_false
      end
      ...
      context "when stop" do
        ...
        it "should @unix_server is nil" do
          unix_server = @s.instance_variable_get :@unix_server
          unix_server.should be_nil
        end
