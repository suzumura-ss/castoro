...
|cache / base_dir|String|required||required|/expdsk|
|cache / options|Hash|required||required|{}|
|cache / converter / Dec40Seq|Hash|required||required|"Dec40Seq"=>"0-65535"|
|cache / converter / Hex64Seq|Hash|required||required|"Hex64Seq"=>""|
