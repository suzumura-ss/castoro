#
#   Deleteright 2010 Ricoh Company, Ltd.
#
  ...
  context 'when initialize' do
    context "with(#{PATH1}, 100)" do
      it 'should raise error' do
        ...
        Proc.new{
          @csm_req = Castoro::Peer::Csm::Request::Delete.new(PATH1, 100)
    ...
    context "with(100, #{PATH2})" do
      it 'should raise error' do
        pending "this case should be checked and rescued."
        Proc.new{
          @csm_req = Castoro::Peer::Csm::Request::Delete.new(100, PATH2)
        }.should raise_error(Castoro::Peer::InternalServerError)
      end
    end
    ...
    context 'with("")' do
      it 'should raise error' do
        pending "this case should be checked and rescued."
        Proc.new{
          @csm_req = Castoro::Peer::Csm::Request::Delete.new("")
        }.should raise_error(Castoro::Peer::InternalServerError)
      end
    end
    ...
    context "with('', #{PATH2})" do
      it 'should raise error' do
        pending "this case should be checked and rescued."
        Proc.new{
          @csm_req = Castoro::Peer::Csm::Request::Delete.new("", PATH2)
        }.should raise_error(Castoro::Peer::InternalServerError)
      end
    end
    ...
    context "with(#{PATH1}, '')" do
      it 'should raise error' do
        pending "this case should be checked and rescued."
        Proc.new{
          @csm_req = Castoro::Peer::Csm::Request::Delete.new(PATH1, "")
        }.should raise_error(Castoro::Peer::InternalServerError)
      end
    end
    ...
    context "with(#{PATH1}, #{PATH2})" do
      before do
        @csm_req = Castoro::Peer::Csm::Request::Delete.new(PATH1, PATH2)
      end

      it 'should be an instance of Castoro::Peer::Csm::Request::Delete' do
        @csm_req.should be_kind_of Castoro::Peer::Csm::Request::Delete
      end
