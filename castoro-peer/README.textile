...
gem install --no-rdoc --no-ri castoro-common-2.0.1.gem castoro-manipulator-2.0.0.gem castoro-peer-2.1.0.gem
</pre>

"cd /usr/local/lib/ruby/gems/1.9.1/gems/castoro-peer-2.1.0/etc/init.d ; make install" will be automatically done during "gem install castoro-peer-2.1.0.gem"
